...
#for-loop:
participants <- c("Ayse", "Arnold", "Jane", "Anton", "Princess", "Pimlapas", "Maria", "Kinanti", "Yanhang", "Shubhra", "Rachel", "Anna", "Kasahun", "Nuredin", "Bikila", "Mahfuz", "Tilahun", "Adweeti", "Bhawana", "Ba Linh")
for(i in 1:length(participants)){
 print(paste0("Hello ", participants[i], ", I'm so glad you are attending this course!"))
}
