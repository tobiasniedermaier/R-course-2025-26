...
summary(assocstats(mytable)) #slightly more comprehensive
...
shapiro.test(normaly_disb) #If p<0.05 -> not normally distributed. On the other hand, a p-value >=0.05 does NOT confirm the presence of a normal distribution! A non-significant test statistic might also mean that your sample was simly too small.
...
#Convenience function for installing (if not installed yet) and loading a package:
